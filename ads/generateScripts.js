...
infoWrapper.addEventListener('mouseleave', () => adLabel.style.display = 'none');
    ...
    function createFeedbackUI(width, height) {
      ...
      whyBtn.style.cssText = 'display:inline-block; padding:8px 9.6px; text-decoration:none; border:1px solid #ccc; border-radius:2px; background:#fff; color: #9e9ea6; cursor:pointer; font-weight:500;box-shadow:0 0 2px rgba(0,0,0,0.12), 0 1px 3px rgba(0,0,0,0.26)';
